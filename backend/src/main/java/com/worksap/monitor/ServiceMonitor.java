package com.worksap.monitor;

import com.worksap.web.exception.ServerInternalErrorException;
...
public class ServiceMonitor {
     ...
     * in a type in the com.worksap.service package or any sub-package
     * under that.
     */
    @Pointcut("execution(* com.worksap.service..*(..))")
     ...
     */
    @AfterThrowing(pointcut = "com.worksap.monitor.ServiceMonitor.serviceLayer()", throwing = "e")
