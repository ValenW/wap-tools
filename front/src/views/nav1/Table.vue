<template>
	<section>
		...
		<!--列表-->
		<el-table :data="textList" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="en" label="English" width="200"  sortable>
			</el-table-column>
			<el-table-column prop="ja" label="Japanese" width="200" sortable>
			</el-table-column>
		...
		<el-col :span="24" class="toolbar">
			...
			<el-button type="danger" @click="downloadTxt" :disabled="this.sels.length===0">下载</el-button>
...
<script>
	...
	import { getTextsapi,getUserListPage, delTextapi, bulkDelTxt, saveTextapi, addUser } from '../../api/api';
		...
		computed:{
			textList(){
				return this.texts.filter(item=>{
					return item.id.toLowerCase().indexOf(this.filters.keyword)>-1
					||item.en.toLowerCase().indexOf(this.filters.keyword)>-1
					||item.ja.toLowerCase().indexOf(this.filters.keyword)>-1
				})
			}
		},
		methods: {
